...
export const TopMenu = () => {
    ...
    <nav className="flex px-5 justify-between items-center w-full">
       ...
       <div className="hidden sm:block">
            <Link className="m-2 p-2 rounded-md transition-all hover:bg-gray-100" href="/gender/men">Mapa</Link>
            <Link className="m-2 p-2 rounded-md transition-all hover:bg-gray-100" href="/gender/women">Edificios</Link>
            <Link className="m-2 p-2 rounded-md transition-all hover:bg-gray-100" href="/gender/kid">Unidades</Link>
        </div>
        ...
        <div className="flex items-center">
            ...
            <Link href={
                ...
                ? '/empty' // TODO cuando queda vacio mandar a la pagina vacia
                : "/cart"
                } className="mx-2">
